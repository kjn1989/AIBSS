...
//
// ---- どうやって出すか ----
// 公開されている勝率表はプロの9回制が前提で、7回制・タイブレーク・コールドの
// あるアマチュアの試合には合わない。だから自分たちの記録から作る。
// 土台にはNPBの実測値(得点期待値・得点確率)を使う。
...
//   加工: していない。掲載の百分率を小数に直しただけ
//
// 得点期待値の表(flow.js BASE_RE)と同じページ・同じ対象期間なので、
// 平均と0点率が別々の出どころになる心配がない。
// 実測が貯まれば buildRunDists の shrink で自分たちの側へ寄っていく。
export const SCORE_PROB = {
  '000|0': 0.222, '100|0': 0.363, '010|0': 0.587, '001|0': 0.798,
  '110|0': 0.573, '101|0': 0.845, '011|0': 0.824, '111|0': 0.840,
  '000|1': 0.123, '100|1': 0.222, '010|1': 0.364, '001|1': 0.648,
  '110|1': 0.373, '101|1': 0.625, '011|1': 0.652, '111|1': 0.646,
  '000|2': 0.049, '100|2': 0.103, '010|2': 0.191, '001|2': 0.235,
  '110|2': 0.210, '101|2': 0.245, '011|2': 0.234, '111|2': 0.299,
};
