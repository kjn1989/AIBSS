...
//
// 外野は定位置の浅め(75〜78%)に置く。チップは押すと吸着する <button> なので、
// 深く置くと「外野の頭を越えた当たり」を狙った指がチップに吸われて、
// 深い当たりのつもりが「定位置」として記録されてしまう。
// 実測(パッド 314x289)では中堅チップの上端が y=65.0 で、「深い」の内側境界
// y=75.8 より上 — チップが「深い」の帯の半分を物理的に覆っていた。
// 前に出すと帯に一切かからなくなり、柵までの余白が 24.4px → 39.8px になる。
// 草野球・部活の外野はもともと浅めなので、実際の守備位置としても無理がない。
export const POS_BALL = {
  LF: { angle: -25.2, depth: 0.75 },
  CF: { angle: 0, depth: 0.78 },
  RF: { angle: 25.2, depth: 0.75 },
